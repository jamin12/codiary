            ...
            <Wrap className="wrap">
              ...
              <ContentWrapBox className='inner-width'>
                ...
                <CommentBox>
                  ...
                  <p className="text-box">일단 글자를 한 번 ㅈㄴ 길게 적어봐야할 것 같아서 한 번test문자 넣어봄 It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                  <DateBox>
                ...
                <ReplyBox>
                  ...
                  <p className="text-box">너무 도움이 많이 되었어요~ 감사합니다^^ <br/> 번창하세요!~!~</p>
                  <DateBox>
                    <p className="date">2022.02.02 12:12</p>
                  </DateBox>
                </ReplyBox>
